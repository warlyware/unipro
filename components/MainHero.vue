      ...
      <main class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
        <div class="text-center">
          ...
          <p class="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            You don't have to be a rocket scientest to benefit from the blockchain.
            Our easy to use platform lets you create a profile that can be used across the internet, forever!
          </p>
